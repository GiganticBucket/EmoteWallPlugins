registerPlugin({
    ...
    ModifyEmoteDataList(message, emoteDataListBuilder) {
        ...
        async function LaunchBarrelRolls(barrelRolls) {
            ...
            let bulletEmote = new OverlayEmote(new EmoteData("barrelRolls.bulletLauncher", "https://giganticbucket.github.io/EmoteWallExtensions/assets/BulletLauncher.png.jpg"), new OverlayEmoteState(2 + lastLaunchApproximatelyAtSeconds), new EmoteConfigurerList(new BulletLauncherConfigurer()), new EmoteBehaviorList(new BulletLauncherBehavior(), new OpacityBehavior([[0, 1], [lastLaunchApproximatelyAtSeconds, 1], [endTimeSeconds, 0]])));
