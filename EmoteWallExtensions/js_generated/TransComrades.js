        ...
        async function LaunchTransPrideEmotes() {
            ...
            for (let wave = 0; wave < numPrideWavesOption.currentValue; wave++) {
                ...
                for (let i = 0; i < numPerWave; i++) {
                    let overlayEmote = new OverlayEmote(new EmoteData("TransgenderPride", "https://static-cdn.jtvnw.net/emoticons/v2/307827377/default/light/3.0"), new OverlayEmoteState(4), alternatingConfigurerLists[i % 2], transPrideBehaviorList);
