...
startOnLeftWallConfigurers.replaceEntryWithNameOrAppend(
    RandomStartPositionConfigurer.name,
    <IOverlayEmoteConfigurer>{
...
function applySideToStart(startingOverlayEmote: OverlayEmote, sideName: string): void {
...
let sideToStartOption: IEditableOption = {
    name: "sideToStart",
